...
print(">>>>>>>>> Filtering 5 label with eyebrows filter <<<<<<<<<<<<")
os.makedirs(r'./pipeline_eyebrows', exist_ok=True)
...
print(">>>>>>>>> Normalize 5 label with eyebrows filter <<<<<<<<<<<<")
...
data, input_data = get_input(df_eyebrows, filter_eyebrows, scaler)
...
data, input_data = get_input(df_right, filter_eyebrows, scaler)
y_pred_onehot = get_output(input_data, model)
plot_data_result(
...
data, input_data = get_input(df_left, filter_eyebrows, scaler)
y_pred_onehot = get_output(input_data, model)
plot_data_result(
...
data, input_data = get_input(df_both, filter_eyebrows, scaler)
y_pred_onehot = get_output(input_data, model)
plot_data_result(
...
data, input_data = get_input(df_teeth, filter_eyebrows, scaler)
y_pred_onehot = get_output(input_data, model)
plot_data_result(
