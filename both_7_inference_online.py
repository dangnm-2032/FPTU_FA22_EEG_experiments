...
##################### MODEL ###############################################
model = load_model(r'.\pipeline_both\checkpoints\checkpoint.keras')
###########################################################################


##################### SCALER ##############################################
import joblib
scaler = joblib.load(r'.\pipeline_both\checkpoints\scaler.save')  
###########################################################################
...
while True:
    ...
    ########################### Preprocessing ###################################
    x = pipeline(eeg_data, filter_both, scaler)
